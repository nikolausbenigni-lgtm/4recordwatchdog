...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://cdn.tailwindcss.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: http: blob:; font-src 'self' https://fonts.gstatic.com; frame-src https://googleads.g.doubleclick.net https://tpc.googlesyndication.com https://bid.g.doubleclick.net; connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net;" />
  ...
  <div id="cookie-banner" class="fixed bottom-0 left-0 right-0 z-[100] border-t border-slate-200 bg-white p-4 shadow-2xl sm:p-6">
    <div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row">
      <div class="text-center sm:text-left">
        ...
        <p class="mt-1 text-sm text-slate-600">We use cookies to enhance your browsing experience, serve personalized ads, and analyze our traffic. By clicking "Accept All", you consent to our use of cookies. Read our <a href="/privacy-policy/" class="font-bold text-accent underline">Privacy Policy</a>.</p>
      </div>
...
const homeSchema = {
  ...
  "description": "Free directory to search official public records by state. Find business entity filings, county court records, incarceration databases, and bankruptcy filings.",
  "potentialAction": {
    "@type": "SearchAction",
  ...
  <section class="relative overflow-hidden bg-[#071638] text-white">
    ...
    <div class="relative mx-auto grid max-w-7xl gap-12 px-5 py-16 lg:grid-cols-[1.3fr_.7fr] lg:py-20">
      <div>
        ...
        <p class="mt-6 max-w-3xl text-xl leading-8 text-slate-200">Start with a state, then access business entity search, lawsuit records, incarceration records, and bankruptcy tools.</p>
...
writePage('', 'RecordWatchdog - Free Public Records Search Directory', 'Search official public records by state. Access business filings, court records, incarceration data, and bankruptcy tools. Free directory.', homeContent, homeSchema);
