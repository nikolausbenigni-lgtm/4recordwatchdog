...
writePage('privacy-policy', 'Privacy Policy - Data Protection & Cookies | RecordWatchdog', 'Learn how RecordWatchdog protects your privacy, handles data, and uses Google AdSense cookies. We prioritize your security and transparency.', `
...
writePage('terms', 'Terms of Use - FCRA Disclaimer & Guidelines | RecordWatchdog', 'Read our Terms of Use including FCRA disclaimer. RecordWatchdog is not a consumer reporting agency. Learn about user conduct and prohibited uses.', `
  <section class="mx-auto max-w-4xl px-5 py-16">
...
writePage('about', 'About Us - Our Mission & Values | RecordWatchdog', 'Discover RecordWatchdog\'s mission to make public records accessible. Learn about our commitment to transparency, privacy, and official sources only.', `
  <section class="mx-auto max-w-4xl px-5 py-16">
...
writePage('contact', 'Contact Us - Get in Touch | RecordWatchdog', 'Contact the RecordWatchdog team for inquiries, corrections, or business opportunities. Email us or use our contact form for quick responses.', `
  <section class="mx-auto max-w-4xl px-5 py-16">
...
writePage('dmca', 'DMCA Policy - Copyright Takedown Procedures | RecordWatchdog', 'Read our DMCA Policy for copyright infringement notices. Learn how to submit takedown requests and our procedures for handling copyright claims.', `
  <section class="mx-auto max-w-4xl px-5 py-16">
...
writePage('cookie-policy', 'Cookie Policy - How We Use Cookies | RecordWatchdog', 'Learn how RecordWatchdog uses cookies for analytics, advertising, and site functionality. Understand your options for managing and disabling cookies.', `
  <section class="mx-auto max-w-4xl px-5 py-16">
...
writePage('blog', 'Blog - Public Records Guides & Tips | RecordWatchdog', 'Read expert guides on public records, court searches, business filings, and legal research. Tips and insights from the RecordWatchdog team.', `
...
writePage('', 'RecordWatchdog - Free Public Records Search Directory', 'Search official public records by state. Access business filings, court records, incarceration data, bankruptcy tools, and sex offender registries. Free directory.', `
